...
import { ArrowLeft, Upload, Send, User, Mail, Phone, MapPin, Calendar, FileText } from 'lucide-react';
...
const RecruitmentPage = ({ lang, onBack }: RecruitmentPageProps) => {
  const t = translations[lang].forms.recruitment;
      ...
      <div className="pt-20 min-h-screen bg-gray-50 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-4">
            {lang === 'es' ? '¡Candidatura enviada!' : 'Application submitted!'}
          </h2>
          <p className="text-gray-600 mb-8">
            {lang === 'es' 
              ? 'Gracias por tu interés. Revisaremos tu candidatura y nos pondremos en contacto contigo pronto.' 
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                >
                  ...
                  <option value="operation">{t.areas.operation}</option>
